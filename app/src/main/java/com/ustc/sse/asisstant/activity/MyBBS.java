...
public class MyBBS extends AppCompatActivity implements AdapterView.OnItemClickListener{
        ...
        m_handler = new Handler(){
            ...
            public void handleMessage(Message msg) {
                if (msg.arg1==1){
                    ...
                    Log.d("test"," "+ result);
                    xListView.setAdapter(new ForumDisplayAdapter(MyBBS.this,result));
                ...
                if (msg.arg1==2&&result1!=null){
                    Log.d("test",result1);
                    xListView.setAdapter(new ForumDisplayAdapter(MyBBS.this,result1));
                    xListView.stopLoadMore();
                    //停止刷新
                    xListView.stopRefresh();
                }
    ...
    public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
        ...
        Intent intent = new Intent(MyBBS.this, NewThreadPage.class);
    ...
    private void getData()
    {
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                getDirectorBBS.getData(GetDirectorBBS.BBSSELECTBYID,id+"");
            }
        }).start();
